...
public class Install 
{
    ...
    {	
    	...
    	ScanRejectedPublicationDirectory scanRejDocsDir = new ScanRejectedPublicationDirectory(DirectoryLocations.getRejectedSubmissionFictionFolder(), DirectoryLocations.getRjectedSubmissionPoetryFolder());
    		//Fiction
    	scanRejDocsDir.traverse(DirectoryLocations.getRejectedSubmissionFictionFolder(), Status.REJECTED_SUMBISSON, SubmittedResponse.REJECTED);
    		//Poetry
    	scanRejDocsDir.traverse(DirectoryLocations.getRjectedSubmissionPoetryFolder(), Status.REJECTED_SUMBISSON, SubmittedResponse.REJECTED);
    }
}
